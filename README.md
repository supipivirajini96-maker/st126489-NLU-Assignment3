...
## Web Application for English → Sinhala Translation

A simple **web-based application** was developed to demonstrate the trained Transformer model for **English to Sinhala translation**. The application provides an interactive interface where users can input English text and obtain the corresponding Sinhala translation.
...
The translated Sinhala sentence will be displayed on the web page
